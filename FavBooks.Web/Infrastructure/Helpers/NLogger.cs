...
namespace FavBooks.Web.Infrastructure.Helpers
{
    ...
    public sealed class NLogger : ITraceWriter
    {
        ...
        public void Trace(HttpRequestMessage request, string category, TraceLevel level, Action<TraceRecord> traceAction)
        {
            if (level != TraceLevel.Off)
            {
                ...
                {
                    category = category + Environment.NewLine + "Action Parameters : " + new JavaScriptSerializer().Serialize(traceAction.Target ?? "");
                }
        ...
        private void Log(TraceRecord record)
        {
            ...
            if (record.Request != null)
            {
                ...
                if (HttpContext.Current.User.Identity.IsAuthenticated) {
                    message.Append("UserID: " + HttpContext.Current.User.Identity.GetUserId() + Environment.NewLine);
                }
            }
